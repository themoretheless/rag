...
const PRODUCT_ROUTES: &[(&str, &str)] = &[
    ...
    ("GET", "/v1/lint-wiki"),
    ("GET", "/v1/eval/history"),
    ("GET", "/v1/eval/feedback"),
    ("GET", "/v1/eval/runs"),
    ("GET", "/v1/eval/labels"),
    ("POST", "/v1/eval/labels"),
    ("POST", "/v1/eval/labels/claim"),
    ("GET", "/v1/eval/labels/{id}"),
    ("PUT", "/v1/eval/labels/{id}"),
    ("GET", "/v1/eval/traces"),
    ("POST", "/v1/eval/traces"),
    ("GET", "/v1/eval/traces/{id}"),
    ("GET", "/v1/eval/prompts"),
    ("POST", "/v1/eval/prompts"),
    ("GET", "/v1/eval/prompts/{id}"),
    ("POST", "/v1/eval/judge"),
    ("POST", "/v1/eval/online"),
    ("GET", "/v1/eval/export"),
    ("POST", "/v1/eval/replay"),
    ("GET", "/v1/knowledge"),
    ("PUT", "/v1/knowledge"),
    ("GET", "/v1/knowledge/views"),
    ("POST", "/v1/knowledge/views"),
    ("POST", "/v1/eval/feedback"),
    ("POST", "/v1/eval/feedback/run"),
    ("POST", "/v1/eval/runs/compare"),
    ("GET", "/v1/capabilities"),
    ("GET", "/v1/version"),
    ("GET", "/v1/routes"),
];
