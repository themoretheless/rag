...
~70 tools overload MCP clients. Vision (`ARCHITECTURE_VISION.md` §5): advertise **~25 compile-first tools** by default; advanced MemPalace/maintain stay behind `RAG_TOOLS=full`.
...
Unlocks: `add_drawer`, `kg_*`, tunnels, diary/wake_up, maintain_*, `graph_expand_search`, `get_graph`, etc.
